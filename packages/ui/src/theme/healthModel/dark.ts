...
export const healthModelDark = createTheme({
	palette: {
		mode: "dark",
		primary: {
	...
	components: {
		...
		MuiRadio: {
			styleOverrides: {
				root: {
					color: DASHBOARD_BASE_THEME.COLORS["003"],
					"&.Mui-checked": {
						color: DASHBOARD_BASE_THEME.COLORS.BRAND,
					},
				},
			},
		},
		...
		MuiInputBase: {
			styleOverrides: {
				root: () => ({
					margin: "dense",
					backgroundColor: DASHBOARD_BASE_THEME.COLORS["001"],
				}),
			},
		},
